...
class PrivateIngredientApiTests(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        """Test that only ingredients for the
         authenticated users are returned"""
    ...
    def test_create_ingredient_successfull(self):
        """Test that ingredients created successfully"""
    ...
    def test_create_ingredient_invalid(self):
        """Test that Ingredient create with invalid input"""
        payload = {'name': ''}
    ...
    def test_retrive_ingredients_assigned_unique(self):
        ...
        recipe2 = Recipe.objects.create(
            title='Corrainder eggs on toast',
            time_minutes=20,
            price=5.00,
            user=self.user
        )
